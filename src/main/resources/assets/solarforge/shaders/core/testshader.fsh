...
void main() {
    ...
    finalCol.r += smoothstep(0.0,deltaR,1.0-min(length(uv)*test*2/mixedTime,1.0));
    finalCol.g += smoothstep(0.0,deltaG,1.0-min(length(uv)*test*2/mixedTime,1.0));
    finalCol.b += smoothstep(0.0,deltaB,1.0-min(length(uv)*test*2/mixedTime,1.0));
