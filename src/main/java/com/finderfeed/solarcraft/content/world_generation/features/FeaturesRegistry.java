...
//    public static final ResourceKey<Biome> MOLTEN_BIOME_KEY = ResourceKey.create(Registry.BIOME_REGISTRY,MOLTEN_FOREST_BIOME);
    ...
    public static final DeferredHolder<Feature<?>,Feature<NoneFeatureConfiguration>> BURNT_BIOME_AMBIENCE_1             = FEATURES.register("burnt_biome_tree",()->new MoltenForestAmbience(NoneFeatureConfiguration.CODEC));
    public static final DeferredHolder<Feature<?>,Feature<NoneFeatureConfiguration>> FRAGMENT_RUINS = FEATURES.register("ruins_feature",()->new MoltenForestRuins(NoneFeatureConfiguration.CODEC));
