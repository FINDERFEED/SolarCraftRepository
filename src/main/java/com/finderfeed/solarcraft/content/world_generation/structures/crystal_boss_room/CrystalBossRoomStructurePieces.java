...
public class CrystalBossRoomStructurePieces {
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece( StructureTemplateManager p_163662_, ResourceLocation p_163663_,Rotation rot, BlockPos p_163666_) {
            super(StructurePieces.CRYSTAL_BOSS_ROOM_PIECE.get(), 0, p_163662_, p_163663_, p_163663_.toString(), makeSettings(rot,p_163663_), makePosition(p_163663_,p_163666_,0));
        }

        public Piece(StructurePieceSerializationContext p_163670_, CompoundTag tagCompound) {
            super(StructurePieces.CRYSTAL_BOSS_ROOM_PIECE.get(), tagCompound, p_163670_.structureTemplateManager(), (loc)->{
