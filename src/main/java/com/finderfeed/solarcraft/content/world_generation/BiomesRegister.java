...
public class BiomesRegister {
    ...
    public static final ResourceKey<Biome> RADIANT_LAND_KEY = ResourceKey.create(Registry.BIOME_REGISTRY,new ResourceLocation("solarcraft","radiant_land"));
    public static final ResourceKey<Biome> CRYSTAL_CAVES_KEY = ResourceKey.create(Registry.BIOME_REGISTRY,new ResourceLocation("solarcraft","crystal_caves"));
