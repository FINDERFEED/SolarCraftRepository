...
//            .configured(FeatureConfiguration.NONE,SolarCraftTags.SStructures.HAS_CLEARING_RITUAL_STRUCTURE,true);
    ...
    public static final Holder<Structure> CRYSTAL_BOSS_ROOM = register(Keys.CRYSTAL_BOSS_ROOM,new CrystalBossRoomStructure(structure(SolarCraftTags.SStructures.HAS_CRYSTAL_BOSS_ROOM, GenerationStep.Decoration.SURFACE_STRUCTURES,TerrainAdjustment.BEARD_BOX)));
