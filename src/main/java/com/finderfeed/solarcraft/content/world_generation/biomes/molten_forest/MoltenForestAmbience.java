package com.finderfeed.solarcraft.content.world_generation.biomes.molten_forest;
...
public class MoltenForestAmbience extends Feature<NoneFeatureConfiguration> {
    private static final ResourceLocation TREE = new ResourceLocation("solarcraft:worldgen_features/burnt_forest_ambience1");
    private static final ResourceLocation TREE2 = new ResourceLocation("solarcraft:worldgen_features/burnt_biome_ambience2");
