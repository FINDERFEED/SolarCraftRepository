...
public class SunShardPuzzleStructurePieces {
    private static final ResourceLocation DUNGEON_PIECE = new ResourceLocation(SolarCraft.MOD_ID, "sun_shard_dungeon");
    ...
    public static void start(StructureTemplateManager templateManager, BlockPos pos, Rotation rotation, StructurePieceAccessor pieceList) {
        ...
        pieceList.addPiece(new SunShardPuzzleStructurePieces.Piece(templateManager, DUNGEON_PIECE, rotation,blockpos));
    }
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece( StructureTemplateManager templateManagerIn, ResourceLocation resourceLocationIn,Rotation rot, BlockPos pos) {
            super(StructurePieces.SUN_SHARD_PUZZLE_PIECE.get(), 0, templateManagerIn, resourceLocationIn, resourceLocationIn.toString(),
        ...
        public Piece(StructurePieceSerializationContext p_163670_, CompoundTag tagCompound) {
            super(StructurePieces.SUN_SHARD_PUZZLE_PIECE.get(), tagCompound, p_163670_.structureTemplateManager(), (loc)->{
        ...
        private static BlockPos makePosition(ResourceLocation p_162453_, BlockPos p_162454_, int p_162455_) {
            return p_162454_.offset((Vec3i)SunShardPuzzleStructurePieces.OFFSET.get(p_162453_)).below(p_162455_);
        }
