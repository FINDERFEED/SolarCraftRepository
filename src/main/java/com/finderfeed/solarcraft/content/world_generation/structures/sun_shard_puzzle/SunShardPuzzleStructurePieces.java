...
public class SunShardPuzzleStructurePieces {
    ...
    public static class Piece extends TemplateStructurePiece {
        ...
        public Piece( StructureTemplateManager templateManagerIn, ResourceLocation resourceLocationIn,Rotation rot, BlockPos pos) {
            super(StructurePieces.SUN_SHARD_PUZZLE_PIECE, 0, templateManagerIn, resourceLocationIn, resourceLocationIn.toString(),
        ...
        public Piece(StructurePieceSerializationContext p_163670_, CompoundTag tagCompound) {
            super(StructurePieces.SUN_SHARD_PUZZLE_PIECE, tagCompound, p_163670_.structureTemplateManager(), (loc)->{
