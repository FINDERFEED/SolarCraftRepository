package com.finderfeed.solarcraft.content.entities.projectiles.renderers.models;
...
public class RunicHammerModel extends Model {
	public static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation(SolarCraft.MOD_ID,"textures/entities/runic_hammer.png");
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SolarCraft.MOD_ID, "runic_axe"), "main");
