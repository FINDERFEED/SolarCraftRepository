package com.finderfeed.solarcraft.content.entities.models;// Made with Blockbench 4.1.5
...
public class RunicElementalModel extends EntityModel<RunicElementalBoss> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SolarCraft.MOD_ID, "runic_elemental_model"), "main");
