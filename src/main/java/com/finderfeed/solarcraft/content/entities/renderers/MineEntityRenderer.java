...
public class MineEntityRenderer extends EntityRenderer<MineEntityCrystalBoss> {
    ...
    public static final ResourceLocation MAIN = new ResourceLocation("solarcraft","textures/entities/mine_entity.png");
    public static final ResourceLocation RAY = new ResourceLocation("solarcraft","textures/entities/mine_entity_ray.png");
