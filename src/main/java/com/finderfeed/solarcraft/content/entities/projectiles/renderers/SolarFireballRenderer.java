...
import com.finderfeed.solarcraft.content.entities.projectiles.SolarFireballProjectile;
...
public class SolarFireballRenderer extends EntityRenderer<SolarFireballProjectile> {
    ...
    public static final ResourceLocation LOC = new ResourceLocation(SolarCraft.MOD_ID,"textures/particle/solar_strike_particle_small.png");
