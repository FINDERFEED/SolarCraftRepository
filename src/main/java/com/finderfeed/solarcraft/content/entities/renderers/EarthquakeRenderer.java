...
public class EarthquakeRenderer extends EntityRenderer<EarthquakeEntity> {
    ...
    private static final ResourceLocation LOC = new ResourceLocation(SolarCraft.MOD_ID,"textures/entities/earthquake.png");
    private static final ResourceLocation LOC_EXPL = new ResourceLocation(SolarCraft.MOD_ID,"textures/entities/earthquake_activated.png");
