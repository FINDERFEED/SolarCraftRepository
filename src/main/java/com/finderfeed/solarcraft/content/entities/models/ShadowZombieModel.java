...
public class ShadowZombieModel extends AbstractZombieModel<ShadowZombie> {
    ...
    public static final ResourceLocation LAYER = new ResourceLocation(SolarCraft.MOD_ID,"textures/entities/shadow_zombie_layer.png");
    public static final ResourceLocation MODEL = new ResourceLocation(SolarCraft.MOD_ID,"textures/entities/shadow_zombie.png");
