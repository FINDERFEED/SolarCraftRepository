...
public enum Progression {
    ...
    GIANT_VAULT("giant_vault",1, SolarcraftItems.CHISELED_MAGISTONE.get().getDefaultInstance(), Component.translatable("ach.giant_vault"),nextID(),Component.translatable("pre.giant_vault"),Component.translatable("aft.giant_vault")),
