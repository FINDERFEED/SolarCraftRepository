...
import static com.finderfeed.solarcraft.registries.items.SolarcraftItems.*;
...
public class AncientFragment {
    ...
    public static final AncientFragment RUNIC_TABLE = new AncientFragment(tx("solar_fragment.runic_table"),"runic_table",null,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO,ls(ItemWithRecipe.of(SolarcraftItems.RUNIC_TABLE.get().getDefaultInstance(),"runic_table")),tx("runic_table.lore"),RecipeType.CRAFTING,1).addReferences("fragment","lexicon");

    public static final AncientFragment FRAGMENT = new AncientFragment(tx("solar_fragment.fragment"),"fragment",null,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO, SolarcraftItems.INFO_FRAGMENT.get(),tx("fragment.lore"),1).addReferences("runic_table");
    public static final AncientFragment LEXICON = new AncientFragment(tx("solar_fragment.lexicon"),"lexicon",null,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO, SolarcraftItems.SOLAR_LEXICON.get(),tx("lexicon.lore"),1).addReferences("fragment");
    ...
    public static final AncientFragment RUNIC_ENERGY_PYLON = new AncientFragment(tx("solar_fragment.runic_energy_pylon"),"runic_energy_pylon",null,SubCategoryBase.WORLD,CategoryBase.EXPLORATION, RUNE_ENERGY_PYLON.get(),tx("runic_energy_pylon.lore"),1);

    public static final AncientFragment INFUSING_CRAFTING_TABLE = new AncientFragment(tx("solar_fragment.infusing_crafting_table"),"infusing_crafting_table",null,SubCategoryBase.BEGINNER_BLOCKS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(INFUSING_TABLE.get().getDefaultInstance(),"infusing_crafting_table")),tx("infusing_crafting_table.lore"), RecipeType.CRAFTING,1);


    public static final AncientFragment WAND = new AncientFragment(tx("solar_fragment.wand"),"wand",null,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO,ls(ItemWithRecipe.of(SOLAR_WAND.get().getDefaultInstance(),"solar_wand")),tx("wand.lore"), RecipeType.CRAFTING,1);
    ...
    public static final AncientFragment THROWABLE_LIGHT = new AncientFragment(tx("solar_fragment.throwable_light"),"throwable_light",null,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(THROWN_LIGHT.get().getDefaultInstance(),"thrown_light")),tx("throwable_light.lore"), RecipeType.CRAFTING,1);
    ...
    ),tx("crystals.lore"),SolarcraftRecipeTypes.INFUSING_CRAFTING.get(),2);
    ...
    public static final AncientFragment SOLAR_INFUSER = new AncientFragment(tx("solar_fragment.solar_infuser"),"solar_infuser",ProgressionStage.FORGE.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_BLOCKS,CategoryBase.BEGINNER, List.of(
            ItemWithRecipe.of(SolarcraftItems.INFUSER_ITEM.get().getDefaultInstance(),"solar_infuser"),
            ItemWithRecipe.of(SolarcraftItems.SOLAR_INFUSION_POOL.get().getDefaultInstance(),"solar_forge_infusion_pool")
    ),tx("solar_infuser.lore"),SolarcraftRecipeTypes.INFUSING_CRAFTING.get(),1).addReferences("solar_infuser_structure","solar_infuser_structure_2","solar_infuser_structure_3");
    ...
    ),tx("solar_armor.lore"),SolarcraftRecipeTypes.INFUSING.get(),2);
    public static final AncientFragment ITEM_MAGNET = new AncientFragment(tx("solar_fragment.item_magnet"),"item_magnet",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_BLOCKS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.MAGNET_BLOCK.get().getDefaultInstance(),"infusing_new_magnet_block")),tx("item_magnet.lore"), SolarcraftRecipeTypes.INFUSING.get(),2);
    public static final AncientFragment ILLIDIUM_INGOT = new AncientFragment(tx("solar_fragment.illidium_ingot"),"illidium_ingot",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_MATERIALS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.ILLIDIUM_INGOT.get().getDefaultInstance(),"infusing_new_illidium_ingot")),tx("illidium_ingot.lore"), SolarcraftRecipeTypes.INFUSING.get(),2);
    public static final AncientFragment ALGADIUM_INGOT = new AncientFragment(tx("solar_fragment.algadium_ingot"),"algadium_ingot",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_MATERIALS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.ALGADIUM_INGOT.get().getDefaultInstance(),"infusing_new_algadium_ingot")),tx("algadium_ingot.lore"), SolarcraftRecipeTypes.INFUSING.get(),2);
    public static final AncientFragment BLOCK_BOOMERANG = new AncientFragment(tx("solar_fragment.block_boomerang"),"block_boomerang",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.BLOCK_BOOMERANG.get().getDefaultInstance(),"infusing_new_block_boomerang")),tx("block_boomerang.lore"), SolarcraftRecipeTypes.INFUSING.get(),2);
    public static final AncientFragment ILLIDIUM_SWORD = new AncientFragment(tx("solar_fragment.illidium_sword"),"illidium_sword",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.ILLIDIUM_SWORD.get().getDefaultInstance(),"infusing_new_illidium_sword")),tx("illidium_sword.lore"), SolarcraftRecipeTypes.INFUSING.get(),2).addReferences("illidium_ingot");
    public static final AncientFragment ILLIDIUM_AXE = new AncientFragment(tx("solar_fragment.illidium_axe"),"illidium_axe",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.ILLIDIUM_AXE.get().getDefaultInstance(),"infusing_new_illidium_axe")),tx("illidium_axe.lore"), SolarcraftRecipeTypes.INFUSING.get(),2).addReferences("illidium_ingot");
    public static final AncientFragment ILLIDIUM_SHOVEL = new AncientFragment(tx("solar_fragment.illidium_shovel"),"illidium_shovel",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.ILLIDIUM_SHOVEL.get().getDefaultInstance(),"infusing_new_illidium_shovel")),tx("illidium_shovel.lore"), SolarcraftRecipeTypes.INFUSING.get(),2).addReferences("illidium_ingot");
    public static final AncientFragment ILLIDIUM_HOE = new AncientFragment(tx("solar_fragment.illidium_hoe"),"illidium_hoe",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.GROWTH_HOE.get().getDefaultInstance(),"infusing_new_illidium_hoe")),tx("illidium_hoe.lore"), SolarcraftRecipeTypes.INFUSING.get(),2).addReferences("illidium_ingot");
    public static final AncientFragment ILLIDIUM_PICKAXE = new AncientFragment(tx("solar_fragment.illidium_pickaxe"),"illidium_pickaxe",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.VEIN_MINER.get().getDefaultInstance(),"infusing_new_miner_item")),tx("illidium_pickaxe.lore"), SolarcraftRecipeTypes.INFUSING.get(),2).addReferences("illidium_ingot");
    public static final AncientFragment RUNIC_ENERGY_CHARGER = new AncientFragment(tx("solar_fragment.re_charger"),"re_charger",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_BLOCKS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.RUNIC_ENERGY_CHARGER.get().getDefaultInstance(),"infusing_runic_energy_charger")),tx("re_charger.lore"), SolarcraftRecipeTypes.INFUSING.get(),1);


    public static final AncientFragment AURA_HEALER = new AncientFragment(tx("solar_fragment.aura_healer"),"aura_healer",ProgressionStage.AFTER_CATALYSTS.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_BLOCKS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.AURA_HEALER.get().getDefaultInstance(),"infusing_new_aura_healer_block")),tx("aura_healer.lore"), SolarcraftRecipeTypes.INFUSING.get(),2).addReferences("aura_healer_structure");
    public static final AncientFragment DISC_LAUNCHER = new AncientFragment(tx("solar_fragment.disc_launcher"),"disc_launcher",ProgressionStage.AFTER_CATALYSTS.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.SOLAR_DISC_LAUNCHER.get().getDefaultInstance(),"infusing_new_solar_disc_launcher")),tx("disc_launcher.lore"), SolarcraftRecipeTypes.INFUSING.get(),2).addReferences("re_charger");
    public static final AncientFragment TURRET_RADAR = new AncientFragment(tx("solar_fragment.turret_radar"),"turret_radar",ProgressionStage.AFTER_CATALYSTS.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_MATERIALS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.TURRET_RADAR.get().getDefaultInstance(),"infusing_new_turret_radar")),tx("turret_radar.lore"), SolarcraftRecipeTypes.INFUSING.get(),2);
    public static final AncientFragment SOLAR_TURRET = new AncientFragment(tx("solar_fragment.solar_turret"),"solar_turret",ProgressionStage.AFTER_CATALYSTS.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_BLOCKS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.TURRET_BLOCK.get().getDefaultInstance(),"infusing_new_turret_block")),tx("solar_turret.lore"), SolarcraftRecipeTypes.INFUSING.get(),2).addReferences("charged_qualadium_ingot");
    public static final AncientFragment GLOVES_OF_REACH = new AncientFragment(tx("solar_fragment.gloves_of_reach"),"gloves_of_reach",ProgressionStage.AFTER_CATALYSTS.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(SolarcraftItems.REACH_GLOVES.get().getDefaultInstance(),"infusing_new_gloves_of_reach")),tx("gloves_of_reach.lore"), SolarcraftRecipeTypes.INFUSING.get(),2);
//    public static final AncientFragment MANA_REGEN_AMULET = new AncientFragment(tx("solar_fragment.mana_regen_amulet"),"mana_regen_amulet",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemWithRecipe.of(ItemsRegister.SOLAR_MANA_AMULET.get().getDefaultInstance(),"infusing_new_solar_mana_amulet"),tx("mana_regen_amulet.lore"), SolarcraftRecipeTypes.INFUSING.get(),2);
    ...
    ),tx("catalysts.lore"),SolarcraftRecipeTypes.INFUSING_CRAFTING.get(),1);
    ...
    public static final AncientFragment ELEMENT_WEAVER = new AncientFragment(tx("solar_fragment.element_weaver"),"element_weaver",ProgressionStage.AFTER_LENS.ALL_PROGRESSIONS,SubCategoryBase.SKILLED_BLOCKS,CategoryBase.SKILLED,ls(ItemWithRecipe.of(SolarcraftItems.ELEMENT_WEAVER.get().getDefaultInstance(),"infusing_element_weaver")),tx("element_weaver.lore"), SolarcraftRecipeTypes.INFUSING.get(),5).addReferences("runic_energy_repeater");
    ...
    ),tx("modules.lore"),SolarcraftRecipeTypes.INFUSING.get(),5);

    public static final AncientFragment SOLAR_ENERGY_GENERATOR = new AncientFragment(tx("solar_fragment.solar_energy_generator"),"solar_energy_generator",ProgressionStage.AFTER_LENS.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ENERGY,CategoryBase.MASTER,ls(ItemWithRecipe.of(SolarcraftItems.ENERGY_GENERATOR_BLOCK.get().getDefaultInstance(),"infusing_new_solar_energy_generator")),tx("solar_energy_generator.lore"), SolarcraftRecipeTypes.INFUSING.get(),6).addReferences("solar_energy_repeater","solar_energy_generator_structure");
    public static final AncientFragment SOLAR_CORE = new AncientFragment(tx("solar_fragment.solar_core"),"solar_core",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ENERGY,CategoryBase.MASTER,ls(ItemWithRecipe.of(SolarcraftItems.SOLAR_CORE.get().getDefaultInstance(),"infusing_new_solar_core_block")),tx("solar_core.lore"), SolarcraftRecipeTypes.INFUSING.get(),6).addReferences("solar_energy_generator","solar_energy_repeater","solar_core_structure");
    public static final AncientFragment SOLAR_ENERGY_REPEATER = new AncientFragment(tx("solar_fragment.solar_energy_repeater"),"solar_energy_repeater",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ENERGY,CategoryBase.MASTER, ls(ItemWithRecipe.of(SolarcraftItems.SOLAR_ENERGY_REPEATER.get().getDefaultInstance(),"infusing_crafting_solar_energy_repeater")),tx("solar_energy_repeater.lore"), SolarcraftRecipeTypes.INFUSING_CRAFTING.get(),6);
//    public static final AncientFragment SOLAR_NETWORK_BINDER = new AncientFragment(tx("solar_fragment.solar_network_binder"),"solar_network_binder",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ENERGY,CategoryBase.MASTER, ls(ItemWithRecipe.of(SolarcraftItems.SOLAR_NETWORK_BINDER.get().getDefaultInstance(),"solar_network_binder")),tx("solar_network_binder.lore"),RecipeType.CRAFTING,6).addReferences("solar_energy_repeater");
    ...
    public static final AncientFragment RADIANT_CHESTPLATE = new AncientFragment(tx("solar_fragment.radiant_cuirass"),"radiant_cuirass",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.ARMOR,CategoryBase.ARMOR,ls(ItemWithRecipe.of(SolarcraftItems.RADIANT_CHESTPLATE.get().getDefaultInstance(),"infusing_new_radiant_chestplate")),tx("radiant_cuirass.lore"), SolarcraftRecipeTypes.INFUSING.get(),8);
    public static final AncientFragment MEDIUM_SOLAR_REACTOR = new AncientFragment(tx("solar_fragment.medium_solar_reactor"),"medium_solar_reactor",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_MATERIALS,CategoryBase.MASTER,ls(ItemWithRecipe.of(SolarcraftItems.MEDIUM_SOLAR_REACTOR.get().getDefaultInstance(),"infusing_new_medium_solar_reactor")),tx("medium_solar_reactor.lore"), SolarcraftRecipeTypes.INFUSING.get(),7).addReferences("small_solar_reactor");
    public static final AncientFragment ZAP_TURRET = new AncientFragment(tx("solar_fragment.zap_turret"),"zap_turret",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ITEMS,CategoryBase.MASTER,ls(ItemWithRecipe.of(SolarcraftItems.ZAP_TURRET_BLOCK.get().getDefaultInstance(),"infusing_new_zap_turret")),tx("zap_turret.lore"), SolarcraftRecipeTypes.INFUSING.get(),8).addReferences("zap_turret_structure");
    public static final AncientFragment CHARGED_QUALADIUM_INGOT = new AncientFragment(tx("solar_fragment.charged_qualadium_ingot"),"charged_qualadium_ingot",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_MATERIALS,CategoryBase.MASTER,ls(ItemWithRecipe.of(SolarcraftItems.CHARGED_QUALADIUM_INGOT.get().getDefaultInstance(),"infusing_new_charged_qualadium_ingot")),tx("charged_qualadium_ingot.lore"), SolarcraftRecipeTypes.INFUSING.get(),7).addReferences("qualadium_ingot");
    public static final AncientFragment SOLAR_MORTAR = new AncientFragment(tx("solar_fragment.solar_mortar"),"solar_mortar",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ITEMS,CategoryBase.MASTER,ls(ItemWithRecipe.of(SolarcraftItems.SOLAR_MORTAR.get().getDefaultInstance(),"infusing_new_solar_mortar_block")),tx("solar_mortar.lore"), SolarcraftRecipeTypes.INFUSING.get(),8).addReferences("solar_mortar_structure");
    public static final AncientFragment SOLAR_FURNACE = new AncientFragment(tx("solar_fragment.solar_furnace"),"solar_furnace",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ITEMS,CategoryBase.MASTER,ls(ItemWithRecipe.of(SolarcraftItems.SOLAR_FURNACE_BLOCK.get().getDefaultInstance(),"infusing_new_solar_furnace")),tx("solar_furnace.lore"), SolarcraftRecipeTypes.INFUSING.get(),8).addReferences("solar_energy_repeater");
    public static final AncientFragment  TOTEM_OF_IMMORTALITY = new AncientFragment(tx("solar_fragment.totem_of_immortality"),"totem_of_immortality",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ITEMS,CategoryBase.MASTER,ls(ItemWithRecipe.of(SolarcraftItems.TOTEM_OF_IMMORTALITY.get().getDefaultInstance(),"infusing_new_totem_of_immortality")),tx("totem_of_immortality.lore"), SolarcraftRecipeTypes.INFUSING.get(),8);
    public static final AncientFragment SOLAR_CROSSBOW = new AncientFragment(tx("solar_fragment.solar_crossbow"),"solar_crossbow",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ITEMS,CategoryBase.MASTER,ls(ItemWithRecipe.of(SolarcraftItems.ULTRA_CROSSBOW.get().getDefaultInstance(),"infusing_new_solar_crossbow")),tx("solar_crossbow.lore"), SolarcraftRecipeTypes.INFUSING.get(),8).addReferences("re_charger");
    public static final AncientFragment LIGHTNING_GUN = new AncientFragment(tx("solar_fragment.lightning_gun"),"lightning_gun",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ITEMS,CategoryBase.MASTER,ls(ItemWithRecipe.of(SolarcraftItems.LIGHTNING_GUN.get().getDefaultInstance(),"infusing_new_lightning_emitter")),tx("lightning_gun.lore"), SolarcraftRecipeTypes.INFUSING.get(),8).addReferences("re_charger");
    public static final AncientFragment DIMENSION_CORE = new AncientFragment(tx("solar_fragment.dimension_core"),"dimension_core",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ITEMS,CategoryBase.MASTER,ls(ItemWithRecipe.of(SolarcraftItems.DIMENSION_CORE.get().getDefaultInstance(),"infusing_new_dimension_core")),tx("dimension_core.lore"), SolarcraftRecipeTypes.INFUSING.get(),9).addReferences("dimension_structure");
    ...
    ),tx("amulets.lore"),SolarcraftRecipeTypes.INFUSING.get(),5);
    ...
    ),tx("divine_armor.lore"),SolarcraftRecipeTypes.INFUSING.get(),9);

    public static final AncientFragment ORBITAL_MISSILE_LAUNCHER = new AncientFragment(tx("solar_fragment.orbital_missile_launcher"),
            ...
            ls(ItemWithRecipe.of(SolarcraftItems.ORBITAL_MISSILE_LAUNCHER.get().getDefaultInstance(),"infusing_orbital_missile_launcher")),
            tx("orbital_missile_launcher.lore"), SolarcraftRecipeTypes.INFUSING.get(),9)
            .addReferences("runic_energy_repeater","crystal_cores");


    public static final AncientFragment AURA_HEALER_STRUCTURE = new AncientFragment(tx("solar_fragment.aura_healer_structure"),"aura_healer_structure",AURA_HEALER.neededProgression,SubCategoryBase.STRUCTURES,CategoryBase.STRUCTURES, Multiblocks.AURA_HEALER, AURA_HEALER.priority).addReferences("aura_healer");
    public static final AncientFragment SOLAR_MORTAR_STRUCTURE = new AncientFragment(tx("solar_fragment.solar_mortar_structure"),"solar_mortar_structure",SOLAR_MORTAR.neededProgression,SubCategoryBase.STRUCTURES,CategoryBase.STRUCTURES, Multiblocks.SOLAR_MORTAR, SOLAR_MORTAR.priority).addReferences("solar_mortar");
    public static final AncientFragment INFUSER_TIER_BEGINNER = new AncientFragment(tx("solar_fragment.solar_infuser_structure"),"solar_infuser_structure",SOLAR_INFUSER.neededProgression,SubCategoryBase.STRUCTURES,CategoryBase.STRUCTURES, Multiblocks.INFUSER_TIER_ONE, SOLAR_INFUSER.priority).addReferences("solar_infuser");
    public static final AncientFragment INFUSER_TIER_RUNIC_ENERGY = new AncientFragment(tx("solar_fragment.solar_infuser_structure_2"),"solar_infuser_structure_2",ProgressionStage.AFTER_LENS.ALL_PROGRESSIONS, SubCategoryBase.STRUCTURES,CategoryBase.STRUCTURES, Multiblocks.INFUSER_TIER_TWO, SOLAR_INFUSER.priority).addReferences("solar_infuser");
    public static final AncientFragment INFUSER_TIER_SOLAR_ENERGY = new AncientFragment(tx("solar_fragment.solar_infuser_structure_3"),"solar_infuser_structure_3",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.STRUCTURES,CategoryBase.STRUCTURES, Multiblocks.INFUSER_TIER_THREE, SOLAR_INFUSER.priority).addReferences("solar_infuser");


    public static final AncientFragment SOLAR_CORE_STRUCTURE = new AncientFragment(tx("solar_fragment.solar_core_structure"),"solar_core_structure",SOLAR_CORE.neededProgression,SubCategoryBase.STRUCTURES,CategoryBase.STRUCTURES, Multiblocks.SOLAR_CORE, SOLAR_CORE.priority).addReferences("solar_core");
    public static final AncientFragment SOLAR_ENERGY_GENERATOR_STRUCTURE = new AncientFragment(tx("solar_fragment.solar_energy_generator_structure"),"solar_energy_generator_structure",SOLAR_ENERGY_GENERATOR.neededProgression,SubCategoryBase.STRUCTURES,CategoryBase.STRUCTURES, Multiblocks.ENERGY_GENERATOR, SOLAR_ENERGY_GENERATOR.priority).addReferences("solar_energy_generator");
    ...
    public static final AncientFragment ORBITAL_MISSILE_LAUNCHER_STRUCTURE = new AncientFragment(tx("solar_fragment.orbital_missile_launcher_structure"),"orbital_missile_launcher_structure",ORBITAL_MISSILE_LAUNCHER.neededProgression,SubCategoryBase.STRUCTURES,CategoryBase.STRUCTURES, Multiblocks.ORBITAL_MISSILE_LAUNCHER, ORBITAL_MISSILE_LAUNCHER.priority).addReferences("orbital_missile_launcher");
    ...
    AncientFragment(Component translation, String id, Progression[] neededProgression, SubCategoryBase subBase, CategoryBase catBase, List<ItemWithRecipe> item, Component upgradeLore,RecipeType<?> type, int priority){
