...
public class AncientFragment {
    ...
    public static final AncientFragment RUNIC_TABLE = new AncientFragment("runic_table",null,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO,ls(ItemWithRecipe.of(SolarcraftItems.RUNIC_TABLE.get().getDefaultInstance(),"runic_table")),tx("runic_table.lore"),RecipeType.CRAFTING,0).addReferences("fragment","lexicon");

    public static final AncientFragment FRAGMENT = new AncientFragment("fragment",null,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO, SolarcraftItems.INFO_FRAGMENT.get(),tx("fragment.lore"),0).addReferences("runic_table");
    public static final AncientFragment LEXICON = new AncientFragment("lexicon",null,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO, SolarcraftItems.SOLAR_LEXICON.get(),tx("lexicon.lore"),0).addReferences("fragment");

    public static final AncientFragment RUNES = new AncientFragment("runes",null,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO,ls(ItemWithRecipe.of(SOLAR_RUNE_ARDO.get().getDefaultInstance(),"runestone")),tx("runes.lore"),RecipeType.CRAFTING,0).addReferences("runic_table","fragment");


    public static final AncientFragment DUSTS = new AncientFragment("dusts",null,SubCategoryBase.WORLD,CategoryBase.EXPLORATION, SolarcraftItems.ENERGY_DUST.get(),tx("dusts.lore"),1);

    public static final AncientFragment RUNIC_ENERGY_PYLON = new AncientFragment("runic_energy_pylon",null,SubCategoryBase.WORLD,CategoryBase.EXPLORATION, RUNE_ENERGY_PYLON.get(),tx("runic_energy_pylon.lore"),1);

    public static final AncientFragment INFUSING_CRAFTING_TABLE = new AncientFragment("infusing_crafting_table",null,SubCategoryBase.BEGINNER_BLOCKS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(INFUSING_TABLE.get().getDefaultInstance(),"infusing_crafting_table")),tx("infusing_crafting_table.lore"), RecipeType.CRAFTING,1);


    public static final AncientFragment WAND = new AncientFragment("wand",null,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO,ls(ItemWithRecipe.of(SOLAR_WAND.get().getDefaultInstance(),"solar_wand")),tx("wand.lore"), RecipeType.CRAFTING,1);

    public static final AncientFragment HIDDEN_ORES = new AncientFragment("hidden_ores",ProgressionStage.PRE_BEGGINING.ALL_PROGRESSIONS,SubCategoryBase.WORLD,CategoryBase.EXPLORATION, Items.STONE,tx("hidden_ores.lore"),1);
    public static final AncientFragment THROWABLE_LIGHT = new AncientFragment("throwable_light",null,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ls(ItemWithRecipe.of(THROWN_LIGHT.get().getDefaultInstance(),"thrown_light")),tx("throwable_light.lore"), RecipeType.CRAFTING,1);
    ...
    public static final AncientFragment EIGHT_ELEMENTS = new AncientFragment("eight_elements",ProgressionStage.BEGGINING_2.ALL_PROGRESSIONS,SubCategoryBase.WORLD,CategoryBase.EXPLORATION,"eight_elements_lore", SolarcraftItems.SOLAR_RUNE_ARDO.get().getDefaultInstance(),1);
    ...
    public static final AncientFragment DEATH = new AncientFragment("death",ProgressionStage.PRE_BEGGINING.ALL_PROGRESSIONS,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO, Items.SKELETON_SKULL,tx("death.lore"),1);
...
//    public static final AncientFragment MANA_REGEN_AMULET = new AncientFragment(tx("solar_fragment.mana_regen_amulet"),"mana_regen_amulet",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemWithRecipe.of(ItemsRegister.SOLAR_MANA_AMULET.get().getDefaultInstance(),"infusing_new_solar_mana_amulet"),tx("mana_regen_amulet.lore"), SolarcraftRecipeTypes.INFUSING.get(),2);
    ...
    public static final AncientFragment SOLAR_LENS = new AncientFragment("solar_lens",ProgressionStage.PRE_LENS.ALL_PROGRESSIONS,SubCategoryBase.SKILLED_ITEMS,CategoryBase.SKILLED,ls(ItemWithRecipe.of(SolarcraftItems.SOLAR_LENS.get().getDefaultInstance(),"infusing_new_solar_lens")),tx("solar_lens.lore"), SolarcraftRecipeTypes.INFUSING.get(),3);
...
//    public static final AncientFragment SOLAR_NETWORK_BINDER = new AncientFragment(tx("solar_fragment.solar_network_binder"),"solar_network_binder",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ENERGY,CategoryBase.MASTER, ls(ItemWithRecipe.of(SolarcraftItems.SOLAR_NETWORK_BINDER.get().getDefaultInstance(),"solar_network_binder")),tx("solar_network_binder.lore"),RecipeType.CRAFTING,6).addReferences("solar_energy_repeater");
    ...
    public static final AncientFragment RADIANT_LAND_LORE = new AncientFragment("radiant_land",ProgressionStage.DIMENSION.ALL_PROGRESSIONS,SubCategoryBase.RADIANT_LAND,CategoryBase.ENDGAME,"radiant_land_lore", SolarcraftItems.DIMENSION_CORE.get().getDefaultInstance(),8);
    public static final AncientFragment DEFENCE_CRYSTAL = new AncientFragment("defence_crystal",ProgressionStage.DIMENSION.ALL_PROGRESSIONS,SubCategoryBase.RADIANT_LAND,CategoryBase.ENDGAME,"defence_crystal_lore", SolarcraftItems.CRYSTALLITE_CORE.get().getDefaultInstance(),9);
    ...
    AncientFragment( String id, Progression[] neededProgression, SubCategoryBase subBase, CategoryBase catBase, Item Icon, Component lore, int priority){
    ...
    AncientFragment( String id, Progression[] neededProgression, SubCategoryBase subBase, CategoryBase catBase, List<ItemWithRecipe> item, Component upgradeLore,RecipeType<?> type, int priority){
