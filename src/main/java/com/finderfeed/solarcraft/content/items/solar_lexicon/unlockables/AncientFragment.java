...
public class AncientFragment {
    ...
    public static final AncientFragment ENDER_RADAR = new AncientFragment("ender_radar",ProgressionStage.PRE_FORGE.SELF_PROGRESSIONS,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER, ls(ItemWithRecipe.of(SCItems.ENDER_RADAR.get().getDefaultInstance(),"ender_radar")),SolarcraftRecipeTypes.INFUSING_CRAFTING.get(),2);
...
//    public static final AncientFragment MANA_REGEN_AMULET = new AncientFragment(tx("solar_fragment.mana_regen_amulet"),"mana_regen_amulet",ProgressionStage.AFTER_INFUSER.ALL_PROGRESSIONS,SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemWithRecipe.of(ItemsRegister.SOLAR_MANA_AMULET.get().getDefaultInstance(),"infusing_new_solar_mana_amulet"),tx("mana_regen_amulet.lore"), SolarcraftRecipeTypes.INFUSING.get(),2);
    ...
    public static final AncientFragment BONEMEALER = new AncientFragment("bonemealer",ProgressionStage.AFTER_LENS.ALL_PROGRESSIONS ,SubCategoryBase.SKILLED_BLOCKS,CategoryBase.SKILLED,ls(ItemWithRecipe.of(SCItems.BONEMEALER.get().getDefaultInstance(),"infusing_new_bonemealer")), SolarcraftRecipeTypes.INFUSING.get(),5);
