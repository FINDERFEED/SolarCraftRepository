...
public class AncientFragment {
    ...
    public static final AncientFragment RUNIC_TABLE = new AncientFragment("runic_table",null,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO,ls(ItemWithRecipe.of(SolarcraftItems.RUNIC_TABLE.get().getDefaultInstance(),"runic_table")),RecipeType.CRAFTING,0).addReferences("fragment","lexicon");

    public static final AncientFragment FRAGMENT = new AncientFragment("fragment",null,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO, SolarcraftItems.INFO_FRAGMENT.get(),0).addReferences("runic_table");
    public static final AncientFragment LEXICON = new AncientFragment("lexicon",null,SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO, SolarcraftItems.SOLAR_LEXICON.get(),0).addReferences("fragment");
    ...
    public static final AncientFragment DUSTS = new AncientFragment("dusts",null,SubCategoryBase.WORLD,CategoryBase.EXPLORATION, SolarcraftItems.ENERGY_DUST.get(),1);
    ...
    ),SolarcraftRecipeTypes.INFUSING_CRAFTING.get(),2);
    ...
    ),SolarcraftRecipeTypes.INFUSING_CRAFTING.get(),1).addReferences("solar_infuser_structure","solar_infuser_structure_2","solar_infuser_structure_3");
...
//    public static final AncientFragment SOLAR_NETWORK_BINDER = new AncientFragment(tx("solar_fragment.solar_network_binder"),"solar_network_binder",ProgressionStage.SOLAR_ENERGY.ALL_PROGRESSIONS,SubCategoryBase.MASTER_ENERGY,CategoryBase.MASTER, ls(ItemWithRecipe.of(SolarcraftItems.SOLAR_NETWORK_BINDER.get().getDefaultInstance(),"solar_network_binder")),tx("solar_network_binder.lore"),RecipeType.CRAFTING,6).addReferences("solar_energy_repeater");
    ...
    ),SolarcraftRecipeTypes.INFUSING.get(),9);
