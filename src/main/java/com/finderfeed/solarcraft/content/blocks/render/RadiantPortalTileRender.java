...
import com.finderfeed.solarcraft.content.blocks.blockentities.RadiantPortalTile;
...
public class RadiantPortalTileRender implements BlockEntityRenderer<RadiantPortalTile> {
    ...
    public static final ResourceLocation LOC = new ResourceLocation("solarcraft","textures/misc/radiant_portal.png");
