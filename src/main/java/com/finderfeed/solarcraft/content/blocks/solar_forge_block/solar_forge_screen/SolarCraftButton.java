...
public class SolarCraftButton extends FDButton {
    protected  FDButton.OnTooltip tool;
    public static final ResourceLocation WIDGETS_SOLARCRAFT = new ResourceLocation("solarcraft","textures/gui/solar_button_yellow.png");
    public SolarCraftButton(int posx, int posy, int sizeX, int sizeY, Component component, OnPress onPress) {
        super(posx, posy, sizeX, sizeY, component, onPress);

    }

    public SolarCraftButton(int p_i232255_1_, int p_i232255_2_, Component p_i232255_5_, OnPress p_i232255_6_) {
        super(p_i232255_1_, p_i232255_2_, 65,15, p_i232255_5_, p_i232255_6_);

    }

    public SolarCraftButton(int p_i232256_1_, int p_i232256_2_, int p_i232256_3_, int p_i232256_4_, Component p_i232256_5_, OnPress p_i232256_6_, FDButton.OnTooltip onTooltip) {
        super(p_i232256_1_, p_i232256_2_, p_i232256_3_, p_i232256_4_, p_i232256_5_, p_i232256_6_,onTooltip);
        this.tool = onTooltip;
    }

    public SolarCraftButton(int p_i232256_1_, int p_i232256_2_, Component p_i232256_5_, OnPress p_i232256_6_, FDButton.OnTooltip onTooltip) {
