...
public class CorruptionWispRenderer extends MobRenderer<CorruptionWisp,CorruptionWispModel<CorruptionWisp>> {
    ...
    private static final ResourceLocation WISP = new ResourceLocation(SolarCraft.MOD_ID,"textures/entities/corruption_wisp.png");
    ...
    public static class Layer extends EnergySwirlLayer<CorruptionWisp,CorruptionWispModel<CorruptionWisp>>{
        ...
        private static final ResourceLocation LOC = new ResourceLocation(SolarCraft.MOD_ID,"textures/entities/corruption_wisp_layer.png");
