...
public class CustomTooltip{
    ...
    public CustomTooltip(String texture,int topTextureWidth,int topTextureHeight,int bottomTextureWidth,int bottomTextureHeight,int cornerDimensions,int colBorderStart,int colBorderEnd, int colBackground){
        CORNER_LOCATION = new ResourceLocation(SolarCraft.MOD_ID,"textures/custom_tooltips/" + texture + "_corner.png");
        TOP_LOCATION = new ResourceLocation(SolarCraft.MOD_ID,"textures/custom_tooltips/" + texture + "_top.png");
        BOTTOM_LOCATION = new ResourceLocation(SolarCraft.MOD_ID,"textures/custom_tooltips/" + texture + "_bottom.png");
