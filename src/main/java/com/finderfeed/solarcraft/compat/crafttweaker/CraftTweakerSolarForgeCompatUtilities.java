...
//        map.put("solarcraft:tera_rune_block", 'T');
//        map.put("solarcraft:zeta_rune_block", 'Z');
//        map.put("solarcraft:kelda_rune_block", 'K');
//        map.put("solarcraft:urba_rune_block", 'R');
//        map.put("solarcraft:fira_rune_block", 'F');
//        map.put("solarcraft:ardo_rune_block", 'A');
//        map.put("solarcraft:ultima_rune_block", 'U');
//        map.put("solarcraft:giro_rune_block", 'G');
//    }
//
