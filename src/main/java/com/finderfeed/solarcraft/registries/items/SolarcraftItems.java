...
public class SolarcraftItems {
    ...
    public static final RegistryObject<Item> SOLAR_DISC_LAUNCHER = ITEMS.register("solar_disc_launcher",()-> new SolarDiscGunItem(new Item.Properties().rarity(Rarity.RARE).tab(SolarCraft.SOLAR_GROUP_WEAPONS),()->AncientFragment.DISC_LAUNCHER));
