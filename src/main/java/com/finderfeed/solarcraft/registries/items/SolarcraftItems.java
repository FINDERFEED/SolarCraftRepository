...
public class SolarcraftItems {
    ...
    public static  final RegistryObject<Item> SOLAR_INFUSION_POOL = registerItem(ITEMS.register("solar_forge_infusion_pool",()-> new SolarcraftBlockItem(SolarcraftBlocks.INFUSING_POOL.get(),new Item.Properties().rarity(Rarity.EPIC),()->AncientFragment.SOLAR_INFUSER)),SOLAR_GROUP_BLOCKS);
    ...
    public static final RegistryObject<Item> SOLAR_STONE = registerItem(ITEMS.register("solar_stone",()->new ProgressionBlockItem(SolarcraftBlocks.SOLAR_STONE.get(),new Item.Properties())),SOLAR_GROUP_BLOCKS);
    ...
    //solar armor
    public static final RegistryObject<ArmorItem> SOLAR_HELMET = registerItem(ITEMS.register("solar_helmet",()-> new SolarcraftArmorItem(SolarArmorMaterial.SOLAR_ARMOR, EquipmentSlot.HEAD,new Item.Properties().rarity(Rarity.EPIC),()->AncientFragment.SOLAR_ARMOR)),SOLAR_GROUP);
    public static final RegistryObject<ArmorItem> SOLAR_CHESTPLATE = registerItem(ITEMS.register("solar_chestplate",()-> new SolarcraftArmorItem(SolarArmorMaterial.SOLAR_ARMOR, EquipmentSlot.CHEST,new Item.Properties().rarity(Rarity.EPIC),()->AncientFragment.SOLAR_ARMOR)),SOLAR_GROUP);
    public static final RegistryObject<ArmorItem> SOLAR_LEGGINGS = registerItem(ITEMS.register("solar_leggins",()-> new SolarcraftArmorItem(SolarArmorMaterial.SOLAR_ARMOR, EquipmentSlot.LEGS,new Item.Properties().rarity(Rarity.EPIC),()->AncientFragment.SOLAR_ARMOR)),SOLAR_GROUP);
    public static final RegistryObject<ArmorItem> SOLAR_BOOTS = registerItem(ITEMS.register("solar_boots",()-> new SolarcraftArmorItem(SolarArmorMaterial.SOLAR_ARMOR, EquipmentSlot.FEET,new Item.Properties().rarity(Rarity.EPIC),()->AncientFragment.SOLAR_ARMOR)),SOLAR_GROUP);

    public static final RegistryObject<ArmorItem> DIVINE_HELMET = registerItem(ITEMS.register("divine_helmet",()-> new DivineHelmet(SolarArmorMaterial.DIVINE_ARMOR, EquipmentSlot.HEAD,new Item.Properties().rarity(Rarity.EPIC),()->AncientFragment.DIVINE_ARMOR)),SOLAR_GROUP);
    public static final RegistryObject<ArmorItem> DIVINE_CHESTPLATE = registerItem(ITEMS.register("divine_chestplate",()-> new DivineChestplate(SolarArmorMaterial.DIVINE_ARMOR, EquipmentSlot.CHEST,new Item.Properties().rarity(Rarity.EPIC),()->AncientFragment.DIVINE_ARMOR)),SOLAR_GROUP);
    public static final RegistryObject<ArmorItem> DIVINE_LEGGINGS = registerItem(ITEMS.register("divine_leggings",()-> new DivineLeggings(SolarArmorMaterial.DIVINE_ARMOR, EquipmentSlot.LEGS,new Item.Properties().rarity(Rarity.EPIC),()->AncientFragment.DIVINE_ARMOR)),SOLAR_GROUP);
...
//    public static final RegistryObject<Item> ENERGY_METER = registerItem(ITEMS.register("energy_meter",()->new EnergyMeter(new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<Item> RUNIC_TABLE = registerItem(ITEMS.register("runic_table",()->new SolarcraftBlockItem(SolarcraftBlocks.RUNIC_TABLE.get(),new Item.Properties(),()->AncientFragment.RUNIC_TABLE)),SOLAR_GROUP_BLOCKS);
    ...
    public static final RegistryObject<Item> REPEATER = registerItem(ITEMS.register("repeater",()->new RunicNetworkRepeaterBlockItem(SolarcraftBlocks.REPEATER.get(),new Item.Properties(),()->AncientFragment.RUNIC_ENERGY_REPEATER)),SOLAR_GROUP_BLOCKS);
...
//    public static final RegistryObject<Item> RADIANT_PORTAL_CREATOR = registerItem(ITEMS.register("radiant_portal_creator",()->new PortalCreatorBlockItem(SolarcraftBlocks.RADIANT_LAND_PORTAL_CREATOR.get(),new Item.Properties().tab(SolarForge.SOLAR_GROUP_BLOCKS)));
    ...
    public static final RegistryObject<Item> CRYSTAL_ENERGY_VINES = registerItem(ITEMS.register("crystal_energy_vines",()->new BlockItem(SolarcraftBlocks.CRYSTAL_ENERGY_VINES.get(),new Item.Properties())),SOLAR_GROUP);
    public static final RegistryObject<Item> CLEARING_CRYSTAL_RITUAL = registerItem(ITEMS.register("clearing_ritual_crystal",()->new ClearingRitualCrystalItem(SolarcraftBlocks.CLEARING_RITUAL_CRYSTAL.get(),new Item.Properties())),SOLAR_GROUP);
    ...
    public static final RegistryObject<Item> THROWN_LIGHT = registerItem(ITEMS.register("thrown_light",()->new ThrownLight(SolarcraftBlocks.THROWN_LIGHT.get(),new Item.Properties())),SOLAR_GROUP);
