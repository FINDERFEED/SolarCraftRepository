...
public class ItemsRegister {
    ...
    public static final RegistryObject<Item> ENCHANTER = ITEMS.register("enchanter",()->new SolarcraftBlockItem(BlocksRegistry.ENCHANTER.get(),new Item.Properties().tab(SolarForge.SOLAR_GROUP_BLOCKS),()->null)); //todo:assign a fragment
