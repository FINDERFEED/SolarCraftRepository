package com.finderfeed.solarforge.content.items.divine_armor;
...
public class DivineBoots extends BaseDivineArmor{
    public DivineBoots(ArmorMaterial p_40386_, EquipmentSlot p_40387_, Properties p_40388_, Supplier<AncientFragment> fragmentSupplier) {
