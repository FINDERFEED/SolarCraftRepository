...
public enum ProgressionStage implements Iterable<Progression>{
    ...
    RUNIC_ELEMENTAL(DIMENSION,"dimension",Progression.KILL_RUNIC_ELEMENTAL)
    ;
    ...
    public static ProgressionStage[] STAGES_IN_ORDER = {
      PRE_BEGGINING,BEGGINING,BEGGINING_2,PRE_FORGE,FORGE,AFTER_INFUSER,AFTER_CATALYSTS,PRE_LENS,AFTER_LENS,SOLAR_ENERGY,DIMENSION,RUNIC_ELEMENTAL
    };
