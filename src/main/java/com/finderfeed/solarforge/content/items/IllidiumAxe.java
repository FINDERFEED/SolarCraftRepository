...
import com.finderfeed.solarforge.content.items.primitive.RareSolarcraftAxe;
...
public class IllidiumAxe extends RareSolarcraftAxe {
    ...
    public void appendHoverText(ItemStack p_77624_1_, @Nullable Level p_77624_2_, List<Component> p_77624_3_, TooltipFlag p_77624_4_) {
        p_77624_3_.add(Component.translatable("solarforge.illidium_axe").withStyle(ChatFormatting.GOLD));
