...
import com.finderfeed.solarforge.content.entities.projectiles.BlockBoomerangProjectile;
...
public class BlockBoomerang extends SolarcraftItem {
    ...
    public void appendHoverText(ItemStack p_77624_1_, @Nullable Level p_77624_2_, List<Component> p_77624_3_, TooltipFlag p_77624_4_) {
        p_77624_3_.add(Component.translatable("solarforge.block_boomerang").withStyle(ChatFormatting.GOLD));
