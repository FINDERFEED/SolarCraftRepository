...
//    FIND_INCINERATED_FOREST("find_incinerated_forest",1, SolarcraftItems.BURNT_LOG.get().getDefaultInstance(), Component.translatable("ach.find_incinerated_forest"),nextID(),Component.translatable("pre.find_incinerated_forest"),Component.translatable("aft.find_incinerated_forest")),
    ...
    CRAFT_SOLAR_FORGE("solar_forge_craft",4, SolarForge.SOLAR_FORGE_ITEM.get().getDefaultInstance(),Component.translatable("ach.solar_forge_craft"),nextID(),Component.translatable("pre.solar_forge_craft"),Component.translatable("aft.solar_forge_craft")),
    ...
    SOLAR_INFUSER("solar_infuser_create",5,SolarForge.INFUSER_ITEM.get().getDefaultInstance(),Component.translatable("ach.solar_infuser_create"),nextID(),Component.translatable("pre.solar_infuser_create"),Component.translatable("aft.solar_infuser_create")),
