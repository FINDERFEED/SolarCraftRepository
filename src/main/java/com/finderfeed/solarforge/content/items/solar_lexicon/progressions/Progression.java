package com.finderfeed.solarforge.content.items.solar_lexicon.progressions;
...
//    FIND_INCINERATED_FOREST("find_incinerated_forest",1, SolarcraftItems.BURNT_LOG.get().getDefaultInstance(), new TranslatableComponent("ach.find_incinerated_forest"),nextID(),new TranslatableComponent("pre.find_incinerated_forest"),new TranslatableComponent("aft.find_incinerated_forest")),
    ...
    RUNE_ENERGY_PYLON("rune_energy_deposit",1, SolarcraftItems.RUNE_ENERGY_PYLON.get().getDefaultInstance(),new TranslatableComponent("ach.rune_energy_deposit"),nextID(),new TranslatableComponent("pre.rune_energy_deposit"),new TranslatableComponent("aft.rune_energy_deposit")),
    TRADE_FOR_BLUE_GEM("blue_gem_trade",1, SolarcraftItems.BLUE_GEM.get().getDefaultInstance(), new TranslatableComponent("ach.blue_gem_trade"),nextID(),new TranslatableComponent("pre.blue_gem_trade"),new TranslatableComponent("aft.blue_gem_trade")),
    INFUSING_CRAFTING_TABLE("infusing_crafting_table",1, SolarcraftItems.INFUSING_TABLE.get().getDefaultInstance(), new TranslatableComponent("ach.infusing_crafting_table"),nextID(),new TranslatableComponent("pre.infusing_crafting_table"),new TranslatableComponent("aft.infusing_crafting_table")),
    ...
    IMBUED_COLD_STAR("cold_star_piece_activated",3, SolarcraftItems.COLD_STAR_PIECE_ACTIVATED.get().getDefaultInstance(), new TranslatableComponent("ach.cold_star_piece_activated"),nextID(),new TranslatableComponent("pre.cold_star_piece_activated"),new TranslatableComponent("aft.cold_star_piece_activated")),
    PYLON_INSCRIPTION("pylon_inscription",3, SolarcraftBlocks.INSCRIPTION_STONE.get().asItem().getDefaultInstance(),new TranslatableComponent("ach.pylon_inscription"),nextID(),new TranslatableComponent("pre.pylon_inscription"),new TranslatableComponent("aft.pylon_inscription")),
    ...
    TRANSMUTE_GEM("transmute_gem",4, SolarcraftItems.BLUE_GEM_ENCHANCED.get().getDefaultInstance(), new TranslatableComponent("ach.transmute_gem"),nextID(),new TranslatableComponent("pre.transmute_gem"),new TranslatableComponent("aft.transmute_gem")),
    ...
    DIMENSIONAL_SHARD_DUNGEON("dim_shard_dungeon",5, SolarcraftItems.SOLAR_STONE_CHISELED.get().getDefaultInstance(), new TranslatableComponent("ach.dim_shard_dungeon"),nextID(),new TranslatableComponent("pre.dim_shard_dungeon"),new TranslatableComponent("aft.dim_shard_dungeon")),

    CATALYSTS("catalysts",6, SolarcraftItems.ARDO_RUNE_BLOCK.get().getDefaultInstance(), new TranslatableComponent("ach.catalysts"),nextID(),new TranslatableComponent("pre.catalysts"),new TranslatableComponent("aft.catalysts")),


    CRAFT_SOLAR_LENS("solar_lens_craft",7, SolarcraftItems.SOLAR_LENS.get().getDefaultInstance(), new TranslatableComponent("ach.solar_lens_craft"),nextID(),new TranslatableComponent("pre.solar_lens_craft"),new TranslatableComponent("aft.solar_lens_craft")),
    RUNIC_ENERGY_REPEATER("runic_energy_repeater",7, SolarcraftItems.REPEATER.get().getDefaultInstance(), new TranslatableComponent("ach.runic_energy_repeater"),nextID(),new TranslatableComponent("pre.runic_energy_repeater"),new TranslatableComponent("aft.runic_energy_repeater")),

    CRAFT_SOLAR_ENERGY_GENERATOR("energy_generator_craft",8, SolarcraftItems.ENERGY_GENERATOR_BLOCK.get().getDefaultInstance(), new TranslatableComponent("ach.solar_generator_craft"),nextID(),new TranslatableComponent("pre.solar_generator_craft"),new TranslatableComponent("aft.solar_generator_craft")),
