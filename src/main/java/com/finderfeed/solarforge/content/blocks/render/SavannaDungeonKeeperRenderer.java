...
import com.finderfeed.solarforge.content.blocks.blockentities.SavannaDungeonKeeperTile;
...
public class SavannaDungeonKeeperRenderer extends TileEntityRenderer<SavannaDungeonKeeperTile> {
    ...
    public final ResourceLocation MAIN = new ResourceLocation("solarforge","textures/misc/savanna_dungeon_keeper.png");
