package com.finderfeed.solarforge.content.blocks.blockentities.projectiles.renderers;
...
public class ShadowBoltRenderer extends EntityRenderer<ShadowBolt> {
    ...
    public static final ResourceLocation LOC = new ResourceLocation(SolarForge.MOD_ID,"textures/misc/shadow_bolt.png");
