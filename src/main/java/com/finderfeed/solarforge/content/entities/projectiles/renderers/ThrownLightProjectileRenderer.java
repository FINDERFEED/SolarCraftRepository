...
import com.finderfeed.solarforge.content.entities.projectiles.ThrownLightProjectile;
...
public class ThrownLightProjectileRenderer extends EntityRenderer<ThrownLightProjectile> {
    ...
    private static final ResourceLocation TEXTURE = new ResourceLocation(SolarForge.MOD_ID,"textures/particle/solar_strike_particle.png");
