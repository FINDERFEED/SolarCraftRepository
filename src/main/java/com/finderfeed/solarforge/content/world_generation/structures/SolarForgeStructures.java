...
import com.finderfeed.solarforge.content.world_generation.structures.maze_key_keeper.TrapDungeon;
...
public class SolarForgeStructures {
    ...
    public static final RegistryObject<StructureFeature<NoneFeatureConfiguration>> TRAP_DUNGEON = STRUCTURES.register("trap_dungeon",()-> new TrapDungeon(NoneFeatureConfiguration.CODEC));
