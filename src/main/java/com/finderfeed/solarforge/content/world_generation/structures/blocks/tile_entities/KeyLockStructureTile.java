package com.finderfeed.solarforge.content.world_generation.structures.blocks.tile_entities;
...
public class KeyLockStructureTile extends AbstractStructureBlockentity {
    ...
    public KeyLockStructureTile(BlockPos pos, BlockState state) {
        super(SolarcraftTileEntityTypes.KEY_LOCK_TILE.get(),pos,state, Progression.FIND_KEY_LOCK_DUNGEON, new AABB(-15,-1,-15,15,1,15));
    }
