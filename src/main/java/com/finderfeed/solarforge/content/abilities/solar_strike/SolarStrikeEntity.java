package com.finderfeed.solarforge.content.abilities.solar_strike;
    ...
    public void tick(){
        ...
        if (!this.level.isClientSide){
            ...
            if (LIFE_TICKS >= 60) {
                ...
                SolarForgePacketHandler.INSTANCE.send(PacketDistributor.NEAR.with(PacketDistributor.TargetPoint.p(
