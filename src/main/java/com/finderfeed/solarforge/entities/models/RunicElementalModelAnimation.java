...
public interface RunicElementalModelAnimation {
    void animate(RunicElementalBoss entity,RunicElementalModel model,float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch);
}
