...
public class SmallSolarStrikeParticle extends SpriteTexturedParticle {
    public SmallSolarStrikeParticle(ClientWorld p_i232448_1_, double p_i232448_2_, double p_i232448_4_, double p_i232448_6_, double x, double y, double z) {
