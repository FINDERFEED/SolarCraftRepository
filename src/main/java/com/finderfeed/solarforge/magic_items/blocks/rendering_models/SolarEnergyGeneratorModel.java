...
public class SolarEnergyGeneratorModel extends Model {
	...
	public void renderCore(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha){
		core.render(matrixStack, buffer, packedLight, packedOverlay);
	}
	public void renderRing1(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha){
		ring1.render(matrixStack, buffer, packedLight, packedOverlay);
	}
	public void renderRing2(MatrixStack matrixStack, IVertexBuilder buffer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha){
