...
public enum AncientFragment {
    ...
    WAND(tx("solar_fragment.wand"),"wand",r(Progression.RUNE_ENERGY_DEPOSIT),SubCategoryBase.BEGGINING,CategoryBase.BEGGINING_INFO, ItemsRegister.SOLAR_WAND.get(),tx("wand.lore"),1),
    ...
    SOLAR_INFUSER(tx("solar_fragment.solar_infuser"),"solar_infuser",r(Progression.FIND_SOLAR_STONE),SubCategoryBase.FORGE,CategoryBase.SOLAR_FORGE_BASICS, SolarForge.INFUSING_STAND_ITEM.get(),tx("solar_infuser.lore"),1),
    SOLAR_FORGE(tx("solar_fragment.solar_forge"),"solar_forge",r(Progression.ENTER_NETHER),SubCategoryBase.FORGE,CategoryBase.SOLAR_FORGE_BASICS, SolarForge.SOLAR_FORGE_ITEM.get(),tx("solar_forge.lore"),1),
    SOLAR_HELMET(tx("solar_fragment.solar_helmet"),"solar_helmet",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.ARMOR,CategoryBase.ARMOR,ItemsRegister.SOLAR_HELMET.get().getDefaultInstance(),tx("solar_helmet.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    SOLAR_CHESTPLATE(tx("solar_fragment.solar_chestplate"),"solar_chestplate",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.ARMOR,CategoryBase.ARMOR,ItemsRegister.SOLAR_CHESTPLATE.get().getDefaultInstance(),tx("solar_chestplate.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    SOLAR_LEGGINS(tx("solar_fragment.solar_leggings"),"solar_leggings",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.ARMOR,CategoryBase.ARMOR,ItemsRegister.SOLAR_LEGGINS.get().getDefaultInstance(),tx("solar_leggings.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    SOLAR_BOOTS(tx("solar_fragment.solar_boots"),"solar_boots",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.ARMOR,CategoryBase.ARMOR,ItemsRegister.SOLAR_BOOTS.get().getDefaultInstance(),tx("solar_boots.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    ITEM_MAGNET(tx("solar_fragment.item_magnet"),"item_magnet",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.MAGNET_BLOCK.get().getDefaultInstance(),tx("item_magnet.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    AURA_HEALER(tx("solar_fragment.aura_healer"),"aura_healer",r(Progression.USE_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.AURA_HEALER.get().getDefaultInstance(),tx("aura_healer.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    DISC_LAUNCHER(tx("solar_fragment.disc_launcher"),"disc_launcher",r(Progression.USE_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.SOLAR_DISC_LAUNCHER.get().getDefaultInstance(),tx("disc_launcher.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    TURRET_RADAR(tx("solar_fragment.turret_radar"),"turret_radar",r(Progression.USE_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.TURRET_RADAR.get().getDefaultInstance(),tx("turret_radar.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    SOLAR_TURRET(tx("solar_fragment.solar_turret"),"solar_turret",r(Progression.USE_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.TURRET_BLOCK.get().getDefaultInstance(),tx("solar_turret.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    GLOVES_OF_REACH(tx("solar_fragment.gloves_of_reach"),"gloves_of_reach",r(Progression.USE_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.REACH_GLOVES.get().getDefaultInstance(),tx("gloves_of_reach.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    MANA_REGEN_AMULET(tx("solar_fragment.mana_regen_amulet"),"mana_regen_amulet",r(Progression.USE_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.SOLAR_MANA_AMULET.get().getDefaultInstance(),tx("mana_regen_amulet.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),

    SMALL_SOLAR_REACTOR(tx("solar_fragment.small_solar_reactor"),"small_solar_reactor",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.SMALL_SOLAR_REACTOR.get().getDefaultInstance(),tx("small_solar_reactor.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    ILLIDIUM_INGOT(tx("solar_fragment.illidium_ingot"),"illidium_ingot",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.ILLIDIUM_INGOT.get().getDefaultInstance(),tx("illidium_ingot.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    ALGADIUM_INGOT(tx("solar_fragment.algadium_ingot"),"algadium_ingot",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.ALGADIUM_INGOT.get().getDefaultInstance(),tx("algadium_ingot.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    BLOCK_BOOMERANG(tx("solar_fragment.block_boomerang"),"block_boomerang",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.BLOCK_BOOMERANG.get().getDefaultInstance(),tx("block_boomerang.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    ILLIDIUM_SWORD(tx("solar_fragment.illidium_sword"),"illidium_sword",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.ILLIDIUM_SWORD.get().getDefaultInstance(),tx("illidium_sword.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    ILLIDIUM_AXE(tx("solar_fragment.illidium_axe"),"illidium_axe",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.ILLIDIUM_AXE.get().getDefaultInstance(),tx("illidium_axe.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    ILLIDIUM_SHOVEL(tx("solar_fragment.illidium_shovel"),"illidium_shovel",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.ILLIDIUM_SHOVEL.get().getDefaultInstance(),tx("illidium_shovel.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    ILLIDIUM_HOE(tx("solar_fragment.illidium_hoe"),"illidium_hoe",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.GROWTH_HOE.get().getDefaultInstance(),tx("illidium_hoe.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    ILLIDIUM_PICKAXE(tx("solar_fragment.illidium_pickaxe"),"illidium_pickaxe",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.BEGINNER_ITEMS,CategoryBase.BEGINNER,ItemsRegister.VEIN_MINER.get().getDefaultInstance(),tx("illidium_pickaxe.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),

    SOLAR_LENS(tx("solar_fragment.solar_lens"),"solar_lens",r(Progression.ACQUIRE_COLD_STAR_ACTIVATED),SubCategoryBase.SKILLED_ITEMS,CategoryBase.SKILLED,ItemsRegister.SOLAR_LENS.get().getDefaultInstance(),tx("solar_lens.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    RUNIC_ENERGY_REPEATER(tx("solar_fragment.runic_energy_repeater"),"runic_energy_repeater",r(Progression.ACQUIRE_COLD_STAR_ACTIVATED),SubCategoryBase.RUNIC_ENERGY_TRANSMITTING,CategoryBase.RUNIC_ENERGY,ItemsRegister.REPEATER.get().getDefaultInstance(),tx("runic_energy_repeater.lore"), SolarForge.INFUSING_RECIPE_TYPE,1),
    ...
    AURA_HEALER_STRUCTURE(tx("solar_fragment.aura_healer_structure"),"aura_healer_structure",r(Progression.USE_SOLAR_INFUSER),SubCategoryBase.STRUCTURES,CategoryBase.STRUCTURES,Multiblocks.AURA_HEALER,1),
    ...
    SOLAR_INFUSER_STRUCTURE(tx("solar_fragment.solar_infuser_structure"),"solar_infuser_structure",r(Progression.CRAFT_SOLAR_INFUSER),SubCategoryBase.STRUCTURES,CategoryBase.STRUCTURES,Multiblocks.INFUSER,1),
    ...
    DIMENSION_STRUCTURE(tx("solar_fragment.dimension_structure"),"dimension_structure",r(Progression.DIMENSION_CORE),SubCategoryBase.STRUCTURES,CategoryBase.STRUCTURES,Multiblocks.RADIANT_LAND_PORTAL,1),
    ...
    RADIANT_LAND_LORE(tx("solar_fragment.radiant_land"),"radiant_land",r(Progression.DIMENSION_CORE),SubCategoryBase.RADIANT_LAND,CategoryBase.MIDGAME,"radiant_land_lore",ItemsRegister.DIMENSION_CORE.get().getDefaultInstance(),1),
    DEFENCE_CRYSTAL(tx("solar_fragment.defence_crystal"),"defence_crystal",r(Progression.DIMENSION_CORE),SubCategoryBase.RADIANT_LAND,CategoryBase.MIDGAME,"defence_crystal_lore",ItemsRegister.CRYSTALLITE_CORE.get().getDefaultInstance(),1),
    ;
