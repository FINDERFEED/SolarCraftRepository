...
public enum AncientFragment {
    ...
    SOLAR_INFUSER(tx("solar_fragment.solar_infuser"),"solar_infuser",r(Progression.CRAFT_SOLAR_FORGE),SubCategoryBase.FORGE,CategoryBase.SOLAR_FORGE_BASICS, SolarForge.INFUSING_STAND_ITEM.get(),tx("solar_infuser.lore"),1),
