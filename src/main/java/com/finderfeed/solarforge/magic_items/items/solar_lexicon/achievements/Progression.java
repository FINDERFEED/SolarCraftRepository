...
public enum Progression {
    ...
    RUNE_ENERGY_DEPOSIT("rune_energy_deposit",1, ItemsRegister.RUNE_ENERGY_PYLON.get().getDefaultInstance(),new TranslatableComponent("ach.rune_energy_deposit"),nextID(),new TranslatableComponent("pre.rune_energy_deposit"),new TranslatableComponent("aft.rune_energy_deposit")),
    ...
    ACQUIRE_COLD_STAR("cold_star_piece",3,ItemsRegister.COLD_STAR_PIECE.get().getDefaultInstance(), new TranslatableComponent("ach.cold_star_piece"),nextID(),new TranslatableComponent("pre.cold_star_piece"),new TranslatableComponent("aft.cold_star_piece")),
    ACQUIRE_COLD_STAR_ACTIVATED("cold_star_piece_activated",4,ItemsRegister.COLD_STAR_PIECE_ACTIVATED.get().getDefaultInstance(), new TranslatableComponent("ach.cold_star_piece_activated"),nextID(),new TranslatableComponent("pre.cold_star_piece_activated"),new TranslatableComponent("aft.cold_star_piece_activated")),
    CRAFT_SOLAR_LENS("solar_lens_craft",5,ItemsRegister.SOLAR_LENS.get().getDefaultInstance(), new TranslatableComponent("ach.solar_lens_craft"),nextID(),new TranslatableComponent("pre.solar_lens_craft"),new TranslatableComponent("aft.solar_lens_craft")),
    CRAFT_SOLAR_ENERGY_GENERATOR("energy_generator_craft",6,ItemsRegister.ENERGY_GENERATOR_BLOCK.get().getDefaultInstance(), new TranslatableComponent("ach.solar_generator_craft"),nextID(),new TranslatableComponent("pre.solar_generator_craft"),new TranslatableComponent("aft.solar_generator_craft")),
    ...
    RUNIC_ENERGY_REPEATER("runic_energy_repeater",5,ItemsRegister.REPEATER.get().getDefaultInstance(), new TranslatableComponent("ach.runic_energy_repeater"),nextID(),new TranslatableComponent("pre.runic_energy_repeater"),new TranslatableComponent("aft.runic_energy_repeater")),
    DIMENSION_CORE("dimension_core",7,ItemsRegister.DIMENSION_CORE.get().getDefaultInstance(), new TranslatableComponent("ach.dimension_core"),nextID(),new TranslatableComponent("pre.dimension_core"),new TranslatableComponent("aft.dimension_core")),
    KILL_CRYSTAL_BOSS("crystal_boss",8,ItemsRegister.CRYSTALLITE_CORE.get().getDefaultInstance(), new TranslatableComponent("ach.crystal_boss"),nextID(),new TranslatableComponent("pre.crystal_boss"),new TranslatableComponent("aft.crystal_boss"));
