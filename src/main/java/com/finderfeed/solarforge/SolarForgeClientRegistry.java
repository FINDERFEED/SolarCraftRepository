...
public class SolarForgeClientRegistry {
    ...
    public static void registerClientStuff(final FMLClientSetupEvent event){
        ...
        ItemBlockRenderTypes.setRenderLayer(BlocksRegistry.RUNIC_TREE_SAPLING.get(), RenderType.cutout());
        ...
        BlockEntityRenderers.register(TileEntitiesRegistry.CLEARING_RITUAL_MAIN_BLOCK.get(), ClearingRitualTileRenderer::new);
