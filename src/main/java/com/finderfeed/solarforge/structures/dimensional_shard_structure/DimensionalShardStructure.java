package com.finderfeed.solarforge.structures.dimensional_shard_structure;

import com.finderfeed.solarforge.structures.magician_tower.MagicianTowerPieces;
...
public class DimensionalShardStructure extends Structure<NoFeatureConfig> {
    public DimensionalShardStructure(Codec<NoFeatureConfig> codec){
        super(codec);
    }
