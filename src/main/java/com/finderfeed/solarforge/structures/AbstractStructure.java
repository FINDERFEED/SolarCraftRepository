...
import com.finderfeed.solarforge.SolarGroup;
...
public class AbstractStructure extends Structure<NoFeatureConfig> {


    public AbstractStructure(Codec<NoFeatureConfig> codec){
        super(codec);
    }
