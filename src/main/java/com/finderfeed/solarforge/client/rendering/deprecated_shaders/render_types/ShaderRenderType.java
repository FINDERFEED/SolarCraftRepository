package com.finderfeed.solarforge.client.rendering.deprecated_shaders.render_types;

import com.finderfeed.solarforge.client.rendering.deprecated_shaders.SolarShader;
...
public class ShaderRenderType extends RenderType {
    public ShaderRenderType(String p_i225992_1_, VertexFormat p_i225992_2_, VertexFormat.Mode mode, int p_i225992_4_, boolean p_i225992_5_, boolean p_i225992_6_,
        ...
        super(p_i225992_1_, p_i225992_2_, mode, p_i225992_4_, p_i225992_5_, p_i225992_6_,()->{
            shader.process();
    ...
    public static RenderType textWithShader(ResourceLocation p_228658_0_,SolarShader shader) {
        ...
        return new ShaderRenderType("textwithshader", DefaultVertexFormat.POSITION_COLOR_TEX_LIGHTMAP, VertexFormat.Mode.QUADS, 256, false, true, shader,
