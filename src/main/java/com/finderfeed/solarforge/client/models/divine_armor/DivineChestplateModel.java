...
public class DivineChestplateModel extends HumanoidModel<LivingEntity> {
    ...
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(SolarForge.MOD_ID, "divine_chestplate"), "main");
...
//		this.body.getChild("wings").visible = false;
//
//		if (entity.getItemBySlot(EquipmentSlot.CHEST).getItem() == ItemsRegister.DIVINE_CHESTPLATE.get()){
//			if (stack.getItem() instanceof BaseDivineArmor armor) {
//				int tick = armor.getTick(stack);
...
//		}
//		if (entity.getItemBySlot(EquipmentSlot.HEAD).getItem() == ItemsRegister.DIVINE_HELMET.get()){
//			this.head.visible = true;
//		}
//		if (entity.getItemBySlot(EquipmentSlot.LEGS).getItem() == ItemsRegister.DIVINE_LEGGINGS.get()){
//			this.leftLeg.visible = true;
//			this.rightLeg.visible = true;
//			this.rightBoot.visible = false;
//			this.leftBoot.visible = false;
//		}
//		if (entity.getItemBySlot(EquipmentSlot.FEET).getItem() == ItemsRegister.DIVINE_BOOTS.get()){
